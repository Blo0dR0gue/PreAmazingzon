...
START TRANSACTION;
USE `amazingzon`;
INSERT INTO `amazingzon`.`Address` (`street`, `zipCode`, `streetNumber`, `city`, `user`) VALUES ('Glockengießerwall', '20095', '8', 'Hamburg', 2);
...
START TRANSACTION;
USE `amazingzon`;
INSERT INTO `amazingzon`.`User` (`password`, `email`, `userRole`, `firstname`, `lastname`, `defaultAddress`, `active`) VALUES ('$2y$10$Cvg4eJICZcIhH9cNyYfRu.EZSqpLAXOCQx5kHo3quLT1S9rCCeMnK', 'admin@admin.de', 1, 'Armin', 'Admin', NULL, 1);
INSERT INTO `amazingzon`.`User` (`password`, `email`, `userRole`, `firstname`, `lastname`, `defaultAddress`, `active`) VALUES ('$2y$10$UDBCdD.eFfj3/PX.2MBIYekKWfXe63XOHv.pBOf7dLpIEtuz/3P6a', 'user@user.de', 2, 'Max', 'Musteruser', 1, 1);
