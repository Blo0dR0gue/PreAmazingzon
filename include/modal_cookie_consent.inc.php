        ...
        <div class="modal-dialog py-5" role="document">
            <div class="modal-content rounded-6 shadow">
                ...
                <div class="modal-body py-0">
                    <p>This website uses cookies to enable its extensive fantastic features. Those cookies are only used to enable the website to function. No data is collected for marketing purposes. Agree to the use of cookies to continue to use the services of the website.</p>
                </div>
