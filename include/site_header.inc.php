...
<header class="p-3 bg-dark text-white">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="<?= ROOT_DIR ?>" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                <img src="<?= IMAGE_LOGO_DIR . DIRECTORY_SEPARATOR . "logo_long_inv.svg" ?>" class="bi me-2" width="150" height="40"
                     alt="Company Logo">
            </a>

            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="<?= ROOT_DIR ?>" class="nav-link px-2 text-secondary">Home</a></li>
