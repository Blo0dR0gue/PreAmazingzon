    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <a href="<?= ROOT_DIR ?>" class="d-flex align-items-center mb-2 mb-lg-0">
                <img src="<?= IMAGE_LOGO_DIR . DS . "logo_long_inv.svg" ?>" class="bi me-2" width="150"
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" method="get"
                  action="<?= PAGES_DIR . DS . 'page_products.php' ?>">
            ...
            <?php if (!UserController::isCurrentSessionLoggedIn()) { ?>
                ...
                <div class="text-end">
                    ...
                    <a href="<?= PAGES_DIR . DS . "page_register.php" ?>" class="btn btn-outline-light">Sign-up</a>
                </div>
            <?php } else { ?>
                <!-- shopping cart -->
                ...
                <div class="dropdown text-end">
                    <a href="" class="d-block link-light text-decoration-none dropdown-toggle" id="dropdownUser"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?= IMAGE_DIR . DS . "user_orange.svg" ?>" alt="mdo"
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser">
                        ...
                        <?php if (isset($_SESSION["isAdmin"]) && $_SESSION["isAdmin"] === true) { ?>
                            ...
                            <li>
                                <a class="dropdown-item" href="<?=ADMIN_PAGES_DIR . DS . 'page_categories.php'?>">Manage Categories</a>
                            </li>
                            <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?= INCLUDE_HELPER_DIR . DS . "helper_logout.inc.php" ?>">Logout</a>
                        </li>
                    </ul>
                </div>
            <?php } ?>
