...
if (!isset($_POST["productId"]) || !is_numeric($_POST["productId"])) {
    logData("Toggle Product Activation", "Value is missing or does not have the correct datatype!", LOG_LVL_CRITICAL);
...
if (!isset($product)) {
    logData("Toggle Product Activation", "Product with id: " . $_POST["productId"] ." not found!", LOG_LVL_CRITICAL);
...
if (!isset($product)) {
    logData("Toggle Product Activation", "Product with id: " . $_POST["productId"] ." could not be updated!", LOG_LVL_CRITICAL);
