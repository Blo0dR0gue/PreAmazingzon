...
if (!isset($_POST["userId"]) || !is_numeric($_POST["userId"])) {
    logData("Toggle User Activation", "Value is missing or does not have the correct datatype!", LOG_LVL_CRITICAL);
...
if (!isset($user)) {
    logData("Toggle User Activation", "User with id: " . $_POST["userId"] . " not found!", LOG_LVL_CRITICAL);
...
if (!isset($user)) {
    logData("Toggle User Activation", "User with id: " . $_POST["userId"] . " could not be updated!", LOG_LVL_CRITICAL);
