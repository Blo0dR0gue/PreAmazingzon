...
if (!isset($_POST["userId"]) || !is_numeric($_POST["userId"])) {
    logData("Toggle User Role", "Value is missing or does not have the correct datatype!", LOG_CRITICAL);
...
if (!isset($user)) {
    logData("Toggle User Role", "User with id: " . $_POST["userId"] . " not found!", LOG_CRITICAL);
...
if (!isset($defaultRole)) {
    logData("Toggle User Role", "Default role not found", LOG_CRITICAL);
...
if (!isset($adminRole)) {
    logData("Toggle User Role", "Admin role not found", LOG_CRITICAL);
...
if (!isset($user)) {
    logData("Toggle User Role", "User with id: " . $_POST["userId"] . " could not be updated!", LOG_CRITICAL);
